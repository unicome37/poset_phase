...
The causal-set programme was introduced in its modern form by
Bombelli \emph{et al.}~\cite{Bombelli1987}.
...
\textbf{FLRW} ($d=4$): matter-dominated expansion
\[
a(t)=(1+\kappa t)^{2/3}, \qquad \kappa\in\{0, 0.3, 1.0, 3.0\}.
\]
...
\subsection{Layer 2: First-order bulk recovery of \texorpdfstring{$H$}{H}}
...
Their correlation magnitude approaches
$|\rho(\text{antichain}, \text{spectral})|\to 0.86$,
confirming that both are measuring the same underlying curvature.
...
Reaching $\alpha_{\mathrm{eff}}\to 2$ requires $N\sim 10^9$ in the present
fit family.
