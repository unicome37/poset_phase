...
- zeta-rank CSV: `outputs_confirmatory/prediction_d_dynamic_v9_window52_denoise_confirm_v2/cg_zeta_scan_rankings_variants.csv`
...
- `full` n=52 keep=0.60 gamma=0.2: rho=0.662, p=5e-06
- `no_switch` n=52 keep=0.60 gamma=0.2: rho=0.699, p=5e-06
- `switch` n=52 keep=0.60 gamma=0.2: rho=0.642, p=5e-06
