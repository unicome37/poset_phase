...
- zeta-rank CSV: `outputs_confirmatory/prediction_d_dynamic_v9_window30_confirm_v1/cg_zeta_scan_rankings_variants.csv`
...
- `no_switch` n=30 keep=0.60 gamma=0.8: rho=0.304, p=0.0248
- `full` n=30 keep=0.60 gamma=0.8: rho=0.288, p=0.03299
- `switch` n=30 keep=0.60 gamma=0.8: rho=0.288, p=0.03317
