...
- `full` n=30 keep=0.60 gamma=0.2: rho=0.803, p=5e-06
- `full` n=52 keep=0.60 gamma=0.2: rho=0.820, p=5e-06
- `no_switch` n=30 keep=0.60 gamma=0.2: rho=0.817, p=5e-06
- `no_switch` n=52 keep=0.60 gamma=0.2: rho=0.783, p=5e-06
- `switch` n=30 keep=0.60 gamma=0.2: rho=0.869, p=5e-06
- `switch` n=52 keep=0.60 gamma=0.2: rho=0.657, p=5e-06
