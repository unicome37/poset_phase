...
- zeta-rank CSV: `outputs_confirmatory/prediction_d_dynamic_v9_confirm_rep2/cg_zeta_scan_rankings_variants.csv`
...
- `full` n=30 keep=0.60 gamma=0.8: rho=0.590, p=5e-06
- `switch` n=30 keep=0.60 gamma=0.8: rho=0.538, p=3e-05
- `no_switch` n=30 keep=0.60 gamma=0.8: rho=0.496, p=0.000175
