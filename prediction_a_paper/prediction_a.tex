...
This asymmetric barrier structure makes $3{+}1$ dimensions a \textbf{robust finite-ensemble optimum} of the
...
$\varepsilon = \pi/48$ zero-parameter closure & \textbf{11.31} & \textbf{0.4\%} & Geometric closure \\
\bottomrule
\end{tabular}
\end{table}
...
Four-dimensionality is therefore not a fine-tuned special case but a robust
finite-ensemble optimum of the entropy--connectivity competition.
