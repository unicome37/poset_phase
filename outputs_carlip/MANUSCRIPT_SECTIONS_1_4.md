...
| FLRW | $\kappa=1.0$ ($H_0\approx0.67$) | #3 | #2 | Moderate curvature, near basin boundary |
...
In the weak-to-moderate range (FLRW $\kappa \le 1.0$, Schwarzschild $\phi_0 \le 0.1$), curved families stay within top-2 in almost all conditions at $N=64$–$512$. The occasional rank reversal at baseline-equivalent points (e.g., FLRW $\kappa=0$, Schwarzschild $\phi_0\approx0$) is expected finite-sample noise around the flat limit, not structural failure. Under strong FLRW curvature ($\kappa=3.0$), the rank degrades to #4–#5, consistent with the de Sitter divergent regime. Thus, the qualitative picture extends beyond de Sitter: layered identity is robust under mild curvature, but a curvature-adaptive reference $\mathcal{M}(\text{background})$ is required in strongly curved regimes.
...
| Schwarzschild / FLRW sprinklings (extended pilot, $N=64$–$512$) | ✅ Weak-to-moderate curvature robust (top-2 in almost all tested conditions); strong FLRW curvature diverges (rank #4–#5 at $\kappa=3.0$) |
...
1. **Curvature: de Sitter validated; FLRW/Schwarzschild partially validated.** A de Sitter scan (§4.7) shows that the flat-calibrated screening architecture is robust for $H \leq 0.3$ at all tested $N$ up to 1024: Lor4D retains rank #1 and dS4D retains rank #2 in every one of the 50 $(N, H)$ conditions tested (Tables 6–8). The critical Hubble $H_c \geq 0.3$ at all $N$. At $N = 1024$, the $H = 0$ baseline confirms statistical indistinguishability ($\Delta = +0.001$). Extended pilot tests for matter-FLRW and weak-field Schwarzschild at $N=64$–$512$ show the same qualitative behaviour under weak-to-moderate curvature, while strong FLRW curvature ($\kappa=3.0$) exits top-2. These non-de-Sitter tests remain preliminary (proxy metrics, limited parameterization), and full metric-faithful Schwarzschild/FLRW validation at $N\gtrsim512$ remains open.
...
5. A **curvature robustness program** (§4.7) shows that the screening architecture survives mild curvature across multiple backgrounds. For de Sitter, up to $H \leq 0.3$ at $N \leq 1024$, Lor4D remains #1 and dS4D remains #2 in all 50 tested $(N,H)$ conditions; the $H=0$ limit at $N=1024$ gives $\Delta=+0.001$. Extended pilot tests for matter-FLRW and weak-field Schwarzschild ($N=64$–$512$) show consistent weak-curvature robustness (Table 9), while strong FLRW curvature exits top-2, matching the de Sitter divergent-regime picture.
