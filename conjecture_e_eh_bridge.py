...
def analyze(rows: list[dict], dims: list[int], ns: list[int]) -> str:
    ...
    lines.append("   (first-order, supported §4.1.32). Then construct R = d(d-1)Ĥ²")
    ...
    lines.append("now supported by an entirely independent method (quadratic regression t-tests")
