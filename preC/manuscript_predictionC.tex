...
We study the same ten-family finite causal poset ensemble introduced in the companion papers~\cite{zhang2026predB,zhang2026predA}. Each family is parametrized by the poset size~$N$ (number of elements) and a deterministic seed. The families and their structural signatures are summarized in Table~\ref{tab:families}.
